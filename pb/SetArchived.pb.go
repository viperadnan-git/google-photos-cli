...
type SetArchived_ArchivedItem struct {
	state         protoimpl.MessageState     `protogen:"open.v1"`
	DedupKey      string                     `protobuf:"bytes,1,opt,name=dedup_key,json=dedupKey,proto3" json:"dedup_key,omitempty"` // URL-safe base64 encoded SHA1 hash
...
func (x *SetArchived_ArchivedItem) GetDedupKey() string {
	if x != nil {
		return x.DedupKey
	}
	return ""
...
const file___proto_SetArchived_proto_rawDesc = "" +
	"\n" +
	"\x18.proto/SetArchived.proto\"\xe0\x01\n" +
	"\vSetArchived\x12/\n" +
	"\x05items\x18\x01 \x03(\v2\x19.SetArchived.ArchivedItemR\x05items\x12\x16\n" +
	"\x06field3\x18\x03 \x01(\x03R\x06field3\x1a_\n" +
	"\fArchivedItem\x12\x1b\n" +
	"\tdedup_key\x18\x01 \x01(\tR\bdedupKey\x122\n" +
